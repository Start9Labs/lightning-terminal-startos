...
image.tar: Dockerfile docker_entrypoint.sh assets/utils/*
	DOCKER_CLI_EXPERIMENTAL=enabled docker buildx build --tag start9/lightning-terminal/main:$(VERSION) --platform=linux/amd64 -o type=docker,dest=image.tar -f ./Dockerfile .
